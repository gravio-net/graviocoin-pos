...
# Copyright (c) 2018-2019 The Graviocoin Core developers
...
class ZMQTest(GraviocoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that graviocoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("graviocoind has not been built with zmq enabled.")
