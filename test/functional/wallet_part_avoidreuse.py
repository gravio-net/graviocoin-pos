#!/usr/bin/env python3
# Copyright (c) 2019 The Graviocoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

from test_framework.test_graviocoin import GraviocoinTestFramework, isclose, connect_nodes_bi
from test_framework.util import assert_equal


class WalletGraviocoinAvoidReuseTest(GraviocoinTestFramework):
...
if __name__ == '__main__':
    WalletGraviocoinAvoidReuseTest().main()
