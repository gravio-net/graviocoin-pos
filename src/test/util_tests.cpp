            ...
            ForEachNoDup(conf_actions, SET, SECTION_NEGATE, [&] {
                for (bool soft_set : {false, true}) {
                    for (bool force_set : {false, true}) {
                        for (const std::string& section : {CBaseChainParams::MAINTEST, CBaseChainParams::TESTNET}) {
                            for (const std::string& network : {CBaseChainParams::MAINTEST, CBaseChainParams::TESTNET}) {
...
BOOST_FIXTURE_TEST_CASE(util_ArgsMerge, ArgsMergeTestingSetup)
{
    ...
    BOOST_CHECK_EQUAL(out_sha_hex, "7e367272d1c02fbc17181eebfffc9e654f6f71f21aa149badd0d06616611ace6");
}
