...
static void GraviocoinAddTxPlainPlainNotOwned(benchmark::State& state) { AddTx(state, "plain", "plain", false); }
static void GraviocoinAddTxPlainPlainOwned(benchmark::State& state) { AddTx(state, "plain", "plain", true); }
static void GraviocoinAddTxPlainBlindNotOwned(benchmark::State& state) { AddTx(state, "plain", "blind", false); }
static void GraviocoinAddTxPlainBlindOwned(benchmark::State& state) { AddTx(state, "plain", "blind", true); }
// static void GraviocoinAddTxPlainAnonNotOwned(benchmark::State& state) { AddTx(state, "plain", "anon", false); }
// static void GraviocoinAddTxPlainAnonOwned(benchmark::State& state) { AddTx(state, "plain", "anon", true); }

static void GraviocoinAddTxBlindPlainNotOwned(benchmark::State& state) { AddTx(state, "blind", "plain", false); }
static void GraviocoinAddTxBlindPlainOwned(benchmark::State& state) { AddTx(state, "blind", "plain", true); }
static void GraviocoinAddTxBlindBlindNotOwned(benchmark::State& state) { AddTx(state, "blind", "blind", false); }
static void GraviocoinAddTxBlindBlindOwned(benchmark::State& state) { AddTx(state, "blind", "blind", true); }
static void GraviocoinAddTxBlindAnonNotOwned(benchmark::State& state) { AddTx(state, "blind", "anon", false); }
static void GraviocoinAddTxBlindAnonOwned(benchmark::State& state) { AddTx(state, "blind", "anon", true); }

static void GraviocoinAddTxAnonPlainNotOwned(benchmark::State& state) { AddTx(state, "anon", "plain", false); }
static void GraviocoinAddTxAnonPlainOwned(benchmark::State& state) { AddTx(state, "anon", "plain", true); }
static void GraviocoinAddTxAnonBlindNotOwned(benchmark::State& state) { AddTx(state, "anon", "blind", false); }
static void GraviocoinAddTxAnonBlindOwned(benchmark::State& state) { AddTx(state, "anon", "blind", true); }
static void GraviocoinAddTxAnonAnonNotOwned(benchmark::State& state) { AddTx(state, "anon", "anon", false); }
static void GraviocoinAddTxAnonAnonOwned(benchmark::State& state) { AddTx(state, "anon", "anon", true); }

BENCHMARK(GraviocoinAddTxPlainPlainNotOwned, 100);
BENCHMARK(GraviocoinAddTxPlainPlainOwned, 100);
BENCHMARK(GraviocoinAddTxPlainBlindNotOwned, 100);
BENCHMARK(GraviocoinAddTxPlainBlindOwned, 100);
// BENCHMARK(GraviocoinAddTxPlainAnonNotOwned, 100);
// BENCHMARK(GraviocoinAddTxPlainAnonOwned, 100);

BENCHMARK(GraviocoinAddTxBlindPlainNotOwned, 100);
BENCHMARK(GraviocoinAddTxBlindPlainOwned, 100);
BENCHMARK(GraviocoinAddTxBlindBlindNotOwned, 100);
BENCHMARK(GraviocoinAddTxBlindBlindOwned, 100);
BENCHMARK(GraviocoinAddTxBlindAnonNotOwned, 100);
BENCHMARK(GraviocoinAddTxBlindAnonOwned, 100);

BENCHMARK(GraviocoinAddTxAnonPlainNotOwned, 100);
BENCHMARK(GraviocoinAddTxAnonPlainOwned, 100);
BENCHMARK(GraviocoinAddTxAnonBlindNotOwned, 100);
BENCHMARK(GraviocoinAddTxAnonBlindOwned, 100);
BENCHMARK(GraviocoinAddTxAnonAnonNotOwned, 100);
BENCHMARK(GraviocoinAddTxAnonAnonOwned, 100);
