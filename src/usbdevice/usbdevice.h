...
#ifndef GIO_USBDEVICE_USBDEVICE_H
#define GIO_USBDEVICE_USBDEVICE_H
...
public:
    ...
    bool IsGraviocoinVersion() const override { return txTo && txTo->IsGraviocoinVersion(); }
...
#endif // GIO_USBDEVICE_USBDEVICE_H
