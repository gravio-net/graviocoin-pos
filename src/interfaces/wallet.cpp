...
public:
    ...
    {
        if (::IsGraviocoinWallet(wallet.get())) {
            m_wallet_part = GetGraviocoinWallet(wallet.get());
        }
    }
    ...
    {
        if (total_fee > 0 || ::IsGraviocoinWallet(m_wallet.get())) {
    ...
    bool IsGraviocoinWallet() override
    {
    ...
    CHDWallet *getGraviocoinWallet() override
    {
        return m_wallet_part;
    }
