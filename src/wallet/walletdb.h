...
extern const std::string GIO_EXTACC;
extern const std::string GIO_EXTKEY;
extern const std::string GIO_EXTKEYNAMED;
extern const std::string GIO_SXADDR;
extern const std::string GIO_SXADDRKEYPACK;
extern const std::string GIO_LOCKEDUTXO;
} // namespace DBKeys
