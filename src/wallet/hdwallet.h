...
#ifndef GIO_WALLET_HDWALLET_H
#define GIO_WALLET_HDWALLET_H
...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE_GIO = 20000;
...
public:
    ...
    {
        m_default_address_type = OutputType::LEGACY; // In Graviocoin segwit is enabled for all types
        m_fallback_fee = CFeeRate(DEFAULT_FALLBACK_FEE_GIO);
        m_spk_man->m_graviocoin = this;
    }
    ...
    bool IsGraviocoinWallet() const override { return true; };
