...
public:
    bool IsGraviocoinWallet() const override { return false; };
    /*
     * Main wallet lock.
    ...
    //! For GraviocoinWallet, clear cached balances from wallet called at new block and adding new transaction
