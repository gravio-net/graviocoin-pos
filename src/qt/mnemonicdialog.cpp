// Copyright (c) 2017-2018 The Graviocoin Core developers
...
void MnemonicDialog::on_btnImportFromHwd_clicked()
{
    ...
    m_thread->setObjectName("graviocoin-hwImport");
    m_thread->start();
...
#endif
#endif
            ui->tbxHwdOut->appendPlainText("The Graviocoin app on your device must be open before importing.");
        }
    } else {
        UniValue rv;
