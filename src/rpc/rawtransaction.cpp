...
static UniValue getrawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{
            ...
            "           \"address\"               (string) graviocoin address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
    ...
    if (!fGraviocoinMode && hash == Params().GenesisBlock().hashMerkleRoot) {
...
static UniValue decoderawtransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{"decoderawtransaction",
            ...
            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
            "         \"addresses\" : [           (json array of string)\n"
            "           \"PfqK97PXYfqRFtdYcZw82x3dzPrZbEAcYa\"   (string) graviocoin address\n"
            "           ,...\n"
            "         ]\n"
            "       }\n"
            "     }\n"
...
static UniValue sendrawtransaction(const JSONRPCRequest& request)
{
    ...
    CFeeRate max_raw_tx_fee_rate = fGraviocoinMode ? DEFAULT_MAX_RAW_TX_FEE_RATE : DEFAULT_MAX_RAW_TX_FEE_RATE_BTC;
