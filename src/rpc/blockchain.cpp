...
static UniValue getblockheader(const JSONRPCRequest& request)
{
            ...
            "  \"moneysupply\": xxxxxxx,        (numeric) the total amount of graviocoin in the chain at this block\n"
...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            const auto& txundo = blockUndo.vtxundo.at(fGraviocoinMode ? i : i - 1); // Graviocoin includes coinbase/coinstake in undo data
