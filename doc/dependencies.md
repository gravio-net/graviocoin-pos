...
These are the dependencies currently used by Graviocoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| hidapi | [0.9.0-rc1](https://github.com/graviocoin/hidapi/releases) |  | No |  |  |
