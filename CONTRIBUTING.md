Contributing to Graviocoin Core
============================

The Graviocoin project operates an open contributor model where anyone is
...
Most communication about Graviocoin development happens on [#graviocoin-dev:matrix.org](https://riot.im/app/#/room/#graviocoin-dev:matrix.org), in the Graviocoin Open Development channel on Riot. The easiest way to participate on Riot is
...
The following applies to code changes to the Graviocoin project..

Whether a pull request is merged into Graviocoin Core rests with the project merge
...
Patches that change Graviocoin consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the Graviocoin consensus, it must have been
...
The project leader is the release manager for each Graviocoin Core release.
